namespace voice.blazor.Models
{
    public class ApiEndPointConsts
    {
...
#if DEBUG
        //public const string BaseRoute = "http://localhost:8084/api/" + Version;
        ...
        {
            public const string BonusList = BaseRoute + "bonus/retrive";

            public const string BonusStatus = BaseRoute + "bonus/status";

            public const string BonusPersist = BaseRoute + "bonus/persist";
        }
